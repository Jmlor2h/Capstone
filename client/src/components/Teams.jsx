...
<span className="relative text-ally8">Nuestro</span>
</span>{' '}
talentoso equipo de Profesionales
</h2>
<p className="text-base text-ally8 md:text-lg">
Reinventamos la experiencia de la atención médica para los hispanos en EE.U.U. Todos nuestros médicos empleados hablan español.
</p>
</div>
